...
VALUES
  (1, '$2a$06$OAPObzhRdRXBCbk7Hj/ot.jY3zPwR8n7/mfLtKIgTzdJa4.6TwsIm', 'lvnt@mail.com', 'user', 'Name', 'Surname',
   1);
-- password in plaintext: "password"
INSERT INTO USER (user_id, password, email, username, name, last_name, active)
VALUES
  (2, '$2a$06$OAPObzhRdRXBCbk7Hj/ot.jY3zPwR8n7/mfLtKIgTzdJa4.6TwsIm', 'levo@gmail.com', 'johndoe', 'John', 'Doe', 1);
-- password in plaintext: "password"
INSERT INTO USER (user_id, password, email, username, name, last_name, active)
VALUES (3, '$2a$06$OAPObzhRdRXBCbk7Hj/ot.jY3zPwR8n7/mfLtKIgTzdJa4.6TwsIm', 'lev@gmail.com', 'namesurname', 'Name',
        'Surname', 1);
INSERT INTO USER (user_id, password, email, username, name, last_name, active)
VALUES (4, $2a$10$iiSIYUuVVZqiY69ttIyhPudnV6Dkt2Wv1vxqCsQn1lJMv3cl4SlFG', 'levent@lvnt.com', 'levent', 'lev',
        'ice', 1);
...
VALUES ('Apple', 'Apple Amasya', 100, 3);
INSERT INTO PRODUCT (name, description, quantity, price)
VALUES ('Orange', 'Antalya Finike Orange', 500, 3);
INSERT INTO PRODUCT (name, description, quantity, price)
